    ...
    commands: [
      {
        ...
        flags: [
          ...
          { long: "due-before", type: "date", parser: "parseCliDate", argKey: "dueBefore", description: "Due before date" },
          { long: "due-after", type: "date", parser: "parseCliDate", argKey: "dueAfter", description: "Due after date" },
        ],
        outputShape: "task[]",
      },
    ],
